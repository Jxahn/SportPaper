...
public class PaperSpigotConfig
{
    ...
    public static double knockbackRangeFactor;
    public static double knockbackMaxRangeReduction;
    public static double knockbackStartRange;
    public static double knockbackIdleReduction;

    private static void knockback() {
        knockbackHorizontal = getDouble( "knockback.horizontal", 0.9055D );
        knockbackVertical = getDouble( "knockback.vertical", 0.8835D );
        knockbackRangeFactor = getDouble( "knockback.range-factor", 0.0D );
        knockbackMaxRangeReduction = getDouble( "knockback.max-range-reduction", 0.4D );
        knockbackStartRange = getDouble( "knockback.start-range", 3.0D );
        knockbackIdleReduction = getDouble( "knockback.idle-reduction", 0.6D );
        commands.put("knockback", new KnockbackModificationCommand( "knockback",
                knockbackHorizontal, knockbackVertical,
                knockbackRangeFactor, knockbackMaxRangeReduction, knockbackStartRange, knockbackIdleReduction));
    }

    public static float potionOffset;
    public static float potionMultiplier;
    public static float potionFall;

    private static void potion() {
        potionOffset = (float) getDouble("potion.offset", -20.0F);
        potionMultiplier = (float) getDouble("potion.multiplier", 0.5F);
        potionFall = (float) getDouble("potion.fall", 0.05F);
    }
